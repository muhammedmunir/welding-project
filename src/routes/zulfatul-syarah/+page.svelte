...
<main id="main-content">
	...
	<section class="section bg-soft" aria-label="Ibu bapa pengantin">
		<div class="inner center-text">
			...
			<div class="wave-rule" aria-hidden="true">
				<svg viewBox="0 0 300 14" xmlns="http://www.w3.org/2000/svg">
					<line x1="0" y1="7" x2="108" y2="7" stroke="currentColor" stroke-width="0.6" opacity="0.3"/>
					<path d="M116 7 Q122 2 128 7 Q134 12 140 7 Q146 2 152 7 Q158 12 164 7 Q170 2 176 7 Q182 12 188 7" fill="none" stroke="currentColor" stroke-width="1.2" opacity="0.6"/>
					<line x1="196" y1="7" x2="300" y2="7" stroke="currentColor" stroke-width="0.6" opacity="0.3"/>
				</svg>
			</div>
			...
			<div class="parents-pantun">
				<p>Bunga cempaka harum semerbak,</p>
				<p>Tanda kasih tidak terhingga.</p>
				<p>Dengan doa dan restu yang tidak pernah putus,</p>
				<p>Kami menjemput ke majlis yang mulia ini.</p>
			</div>
	...
	<footer class="page-footer" aria-label="Doa dan penutup">
		...
		<div class="footer-credit">
			<div class="footer-divider" aria-hidden="true">
				<span class="fdline"></span><span class="fdstar">✦</span><span class="fdline"></span>
			</div>

			<p class="footer-made">Syarah &amp; Munir 2026</p>

			<a href="https://wa.me/60135636124?text={encodeURIComponent('Assalamualaikum, saya berminat untuk mendapatkan website jemputan perkahwinan seperti ini.')}" target="_blank" rel="noopener noreferrer" class="footer-wa-btn">
				<svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14" aria-hidden="true">
					<path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
				</svg>
				Berminat website sebegini?
			</a>
			...
			<div class="footer-sponsor">
				...
				<a href="https://www.jomcloud.com" target="_blank" rel="noopener noreferrer" class="sponsor-badge">
					...
					<span class="sponsor-name">JOMCLOUD</span>
				</a>
			</div>
		</div>
	</footer>
...
<style>
	...
	.fdline {
		flex: 1;
		height: 1px;
		background: rgba(192,132,190,0.3);
	}
	...
	.footer-wa-btn:hover { opacity: 0.85; transform: translateY(-1px); }
	...
	.footer-sponsor {
		...
		margin-top: 0.5rem;
		padding-top: 0.75rem;
		border-top: 1px solid rgba(192,132,190,0.18);
	}
	...
	.sponsor-badge {
		...
		border: 1px solid rgba(192,132,190,0.25);
		border-radius: 16px;
		background: rgba(192,132,190,0.06);
		text-decoration: none;
		transition: background 0.2s, border-color 0.2s;
	}

	.sponsor-badge:hover {
		background: rgba(192,132,190,0.14);
		border-color: rgba(192,132,190,0.45);
	}
