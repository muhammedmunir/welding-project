...
<main id="main-content">
	...
	<section id="rsvp" class="section" aria-labelledby="rsvp-title">
		<div class="inner center-text">
			...
			<p class="body-text">
				Untuk membantu kami membuat persiapan, sila sahkan kehadiran anda sebelum <strong>15 Mei 2026</strong>.
			</p>
...
<style>
	...
	.hero {
		...
		background: linear-gradient(160deg, #f5eef5 0%, #eef0f8 50%, #f3eef5 100%);
		display: flex;
		align-items: center;
